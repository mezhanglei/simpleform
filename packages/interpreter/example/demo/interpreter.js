...
// 增加属性
function assignProperty(obj, ...args) {
  args?.forEach((item) => {
...
function cloneASTNode(ast) {
  if (!ast) return;
  return assignProperty(createNewNode(ast), ast);
}
...
var Interpreter = function (code, opt_initFunc) {
  ...
  Interpreter.stripLocations_(cloneNode, undefined, undefined);
