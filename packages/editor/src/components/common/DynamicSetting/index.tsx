...
export interface DynamicSettingRulesProps {
  controlField?: CustomFormNodeProps;
  value?: RuleData[];
    ...
    <CustomModal className={classes.modal} title="添加联动" onOk={handleOk} displayElement={
      (showModal) => (
        <span className={classes.checkbox}>
          ...
          <SvgIcon className={classes.addIcon} onClick={showModal} name="edit" title="编辑" />
          {editDataEmpty && <SvgIcon className={classes.clearIcon} onClick={clearCodeStr} title="清除" name="qingchu" />}
        </span>
      )
    }>
      <DynamicSettingRules
