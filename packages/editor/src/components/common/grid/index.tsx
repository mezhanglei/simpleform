...
import './index.less';
import { CommonFormProps, CustomGenerateWidgetItem, CustomRow } from '../../../formrender';
...
export type CustomRowProps = RowProps & CommonFormProps<unknown, { cols?: Array<CustomGenerateWidgetItem> }>;
