...
export interface ValidatorSettingProps extends CommonFormProps<Array<InputFormRule>> {
 ...
 * 校验规则的配置组件。
 */
const ValidatorSetting: React.FC<ValidatorSettingProps> = (props) => {
...
export default ValidatorSetting;
