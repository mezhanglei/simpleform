...
import { CommonFormProps, EditorGenerateWidgetItem } from '@simpleform/editor';
...
export interface CustomColumnType<V = unknown> extends ColumnType<V>, EditorGenerateWidgetItem {
  key?: string;
  title: string;
