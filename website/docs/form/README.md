...
[![](https://img.shields.io/badge/version-2.2.22-green)](https://www.npmjs.com/package/@simpleform/form)
...
|`clearOnUninstall` | 控件卸载时是否清空表单值（`>=2.2.20`使用） | `boolean` | `true` |
...
|`noStyle` | 移除表单样式，版本要求`>2.2.21` | `boolean` | - |
