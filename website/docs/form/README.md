...
# @simpleform/form
[![](https://img.shields.io/badge/version-2.2.1-green)](https://www.npmjs.com/package/@simpleform/form)
...
:::warning
`>=2.2.0`版本`useFormValues`方法可以在完整表单值中提取对应路径的值组合成新的表单值，旧版本只会返回路径和值的映射。
:::
